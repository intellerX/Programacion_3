...
# Tipos de comida
pyDatalog.create_terms('raices, verduras, frutas, carnes, lacteos, granos, cereal, embutidos')
...
# 1ra regla: Desayuno, se compone de cereales, lacteos, embutidos(carnes), frutas y grasas complementarias
...
# 5ta regla: segundo plato, puede ser un tipo de carnes, o arroz, o pasta
